  ...
  public function categories()
    ...
    protected static function booted(): void
    {
        static::saved(function (Course $course) {
            // remove the course from default learning path if it is free
            if (!$course->is_locked || !$course->is_active) {
                $course->defaultLearningPath?->delete();
            }
        });
    }
    ...
    {
        return $this->belongsToMany(User::class, 'course_user', 'course_id', 'user_id')->withPivot('id', 'created_at');
    }

    public function defaultLearningPath()
    {
        return $this->hasOne(DefaultLearningPath::class);
    }

    public function chapters()
    {
        return $this->hasMany(CurriculumSection::class);
    }
}
