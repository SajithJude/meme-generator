                        ...
                        <td valign="center">
                            <div style="margin: 0px 36px 0px 36px;">
                                <div style=" text-align:center; margin:23px;">
                                    <b style="font-size:19px; color: #ffffbd; font-family:Arial; line-height: 23px;">Verify your Email</b>
                                </div>
                    ...
                    <tr>
                        <td>
                            <p style="margin: 0px 36px 0px 36px; color: white;" class="main-body">
                                ...
                                <a href="{{ $url }}" style="cursor: pointer !important; margin-left: auto; margin-right: auto;">
                                    <button style=" background-color: #ffffbd; color: black; text-align: center; height: 30px; font-size: 13px; border: none; border-radius:20px; padding-left: 5px; padding-right: 5px;" role="button">
                                ...
                                If you did not create an account, let us know at <a href="mailto:academy@susieashfield.com">academy@susieashfield.com</a> so we can get John Wick to find who’s trying to create account with your email. &#128373; &#65039; &#8205;<br><br>
                                Best,<br>
                                Susie<br><br>
