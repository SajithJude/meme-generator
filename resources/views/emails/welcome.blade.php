                    ...
                    <tr>
                        <td>
                            <p style="margin: 0px 36px 0px 36px; color: white;" class="main-body">
                                ...
                                Hopefully, you’ve already logged in and started working your way through the courses. The best way to understand how it
                                works is just to play around and explore, but if there’s anything that doesn’t make sense, just drop an email to:<br><br>
